...
async function loginUser(credentials) {
    ...
    return fetch(' https://34de-2405-9800-b600-90d4-fcf2-b249-79ac-955f.ngrok.io/api/user/login', {
        method: 'POST',
        headers: {
...
function SigninModal(props) {
  ...
  useEffect(() => {
    liff.init({ liffId: "1656735773-AvMkVePR" }).catch((err) => {
      throw err;
    });
  }, []);
        ...
        <Form className="formSignin" onSubmit={handleSubmit}>
          ...
          <div className="d-grid gap-2">
            ...
            <Button variant="success" size="lg" onClick={handleLineLogin}>
              Sign in with Line.{" "}
              <img src="https://img.icons8.com/color/34/000000/line-me.png" />
            </Button>
          </div>
        </Form>
      </Modal.Body>
          ...
          <Nav className="color-nav" style={{ maxHeight: "100px" }}>
            <Nav>
              ...
              >
                ...
                <MenuItem hidden={!user} onClick={handleLogout}>
                  Sign out
                </MenuItem>
              </Menu>
            </Nav>
