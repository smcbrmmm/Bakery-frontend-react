...
const Products = ({ products, setProductList, setProductInCart }) => {
  ...
  useEffect(() => {
    ...
    // fetch(' https://355f-2405-9800-b600-11e1-1c15-f868-bef3-b9eb.ngrok.io/api/products/allProducts', {
    //     method: 'GET',
    //     headers: {
    //         'Content-Type': 'application/json'
    //     }
            ...
            <Col sm={3}>
              <MediaQuery minWidth={1224}>
                ...
                <a href="#" className="cat-menu">
                  <h5
                    className="cat-menu"
                    onClick={() => categoryFilter("roastedPastry")}
                  >
                    {" "}
                ...
                <a href="#" className="cat-menu">
                  <h5
                    className="cat-menu"
                    onClick={() => categoryFilter("riceCracker")}
                  >
                    {" "}
                    Rice Cracker{" "}
                  </h5>
                    ...
                    >
                      ...
                      >
                        <div>
                          ...
                          <MenuItem
                            onClick={() => {
                              categoryFilter("roastedPastry"), handleClose();
                            }}
                          >
                            Roasted Chinese Pastry{" "}
                          </MenuItem>
                          <MenuItem
                            onClick={() => {
                              categoryFilter("riceCracker"), handleClose();
                            }}
                          >
                            Rice Cracker
                          </MenuItem>
