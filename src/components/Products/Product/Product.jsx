...
async function deleteProduct(product) {
  console.log(product)
  return fetch('https://d28e-2405-9800-b600-6272-c9c9-7b42-5f08-2b05.ngrok.io/api/products/delete', {
    method: 'DELETE',
    headers: {
...
async function insertProduct(product) {
  console.log(product)
  return fetch('https://d28e-2405-9800-b600-6272-c9c9-7b42-5f08-2b05.ngrok.io/api/cart/inCart/insert', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
    },
