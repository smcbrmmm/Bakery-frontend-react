...
async function isHaveEmail(email) {
    return fetch('https://22ce-2405-9800-b600-6272-c873-ef36-e159-44b6.ngrok.io/api/user/isHave/' + email, {
        method: 'GET',
        headers: {
...
async function login(user) {
    ...
    return fetch('https://22ce-2405-9800-b600-6272-c873-ef36-e159-44b6.ngrok.io/api/user/loginbyline/' + user.email, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json'
        },
