...
async function isHaveEmail(email) {
    return fetch('https://83b2-2405-9800-b600-6272-154b-d1ba-1f0e-3a84.ngrok.io/api/user/isHave/' + email, {
        method: 'GET',
        headers: {
...
async function login(user) {
    ...
    return fetch('https://83b2-2405-9800-b600-6272-154b-d1ba-1f0e-3a84.ngrok.io/api/user/loginbyline/' + user.email, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json'
        },
