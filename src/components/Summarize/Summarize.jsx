...
const Summarize = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const result = await axios(
        "https://4593-2405-9800-b840-ee03-95f4-56b1-ae06-3678.ngrok.io/api/order/getOrderByDate/" +
          value
      );
      console.log(result);
  ...
  const ClickSearchForm = () => {
    ...
    if (searchOrderId.length === 0) {
      const fetchData = async () => {
        const result = await axios(
          "https://df54-2405-9800-b840-ee03-84dc-3a08-d5a0-96ce.ngrok.io/api/order/getOrderByDate/" +
            date
        );
        console.log(result);
      ...
      const fetchData = async () => {
        const result = await axios(
          "https://4593-2405-9800-b840-ee03-95f4-56b1-ae06-3678.ngrok.io/api/order/getOrderByDateAndOrderId/" +
            date +
            "/" +
            searchOrderId
        );
  ...
  return (
    <div className="page-container">
      ...
      <div className="container">
        <h1 className="main" style={{ textAlign: "center" }}>
          {" "}
          Order Check{" "}
        </h1>
          ...
          {avSearch ? (
            ...
            >
              <div class="custom-search" style={{ width: "19%" }}>
                ...
                ></input>
                <button class="custom-search-botton" onClick={ClickSearchForm}>
                  {" "}
