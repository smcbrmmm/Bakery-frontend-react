...
const Summarize = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const result = await axios(
        "http://df54-2405-9800-b840-ee03-84dc-3a08-d5a0-96ce.ngrok.io/api/order/getOrderByDate/" +
          value
      );
      console.log(result);
  ...
  const ClickSearchForm = () => {
    ...
    if (searchOrderId.length === 0) {
      ...
      const fetchData = async () => {
        const result = await axios(
          "https://df54-2405-9800-b840-ee03-84dc-3a08-d5a0-96ce.ngrok.io/api/order/getOrderByDateAndOrderId/" +
            date +
            "/" +
            searchOrderId
        );
