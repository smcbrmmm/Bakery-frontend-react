            ...
            <Col>
              ...
              >
                ...
                >
                  ...
                  <option
                    value="Waiting for shipment"
                    hidden={order.status === "Confirm , Waiting for shipment"}
                  >
                    Confirm , Waiting for shipment.
                  </option>
                  <option value="Shipping" hidden={order.status === "Shipping"}>
                    Shipping
                  </option>
                  <option
                    value="Completed"
                  ...
                  <option value="Cancel" hidden={order.status === "Cancel"}>
                    Cancel
                  </option>
                </Form.Select>
              </Form.Group>
              ...
              <Button
                ...
                variant="primary"
                onClick={() => {
                  updateStatus(), handleClickSnackBar();
                }}
                style={{
                  display: "block",
                  marginLeft: "auto",
