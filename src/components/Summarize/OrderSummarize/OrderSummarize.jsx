...
async function updateStatusConfirm(order) {
    return fetch('https://b311-2405-9800-b600-6272-1c50-caaf-f6dc-2e24.ngrok.io/api/order/update/status/confirm/' + order.orderId, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
async function updateStatusShipping(order) {
    return fetch('https://b311-2405-9800-b600-6272-1c50-caaf-f6dc-2e24.ngrok.io/api/order/update/status/shipping/' + order.orderId + "/" + order.trackingNo, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
async function updateStatusSuccess(order) {
    return fetch('https://b311-2405-9800-b600-6272-1c50-caaf-f6dc-2e24.ngrok.io/api/order/update/status/success/' + order.orderId, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
