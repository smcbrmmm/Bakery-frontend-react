...
const Cart = ({ cart, setProductInCart }) => {
  ...
  const handleSelect = (e) => {
    ...
    for (var i = 0; i < address.length; i++) {
      if (address[i].place === e.target.value) indexOfValue = i;
    }
          ...
          <Row>
            ...
            <Col sm={4}>
              <div className="mb-4">
                ...
                <Form.Group
                  className="signinInput mb-1 mt-3"
              ...
              <div style={{ marginBottom: "3rem" }}>
                <h4
                  className="main"
                  style={{ fontSize: "26px", marginBottom: "0.5rem" }}
                >
                  Cart Summary
                </h4>
                <div
