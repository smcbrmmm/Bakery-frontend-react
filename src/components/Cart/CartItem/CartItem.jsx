...
async function deleteItemInCart(cartItem) {
  ...
  return fetch('https://b311-2405-9800-b600-6272-1c50-caaf-f6dc-2e24.ngrok.io/api/cart/inCart/deleteItemInCart', {
    method: 'DELETE',
    headers: {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const result = await axios(
          'https://b311-2405-9800-b600-6272-1c50-caaf-f6dc-2e24.ngrok.io/api/products/getProductQty/' + item.id ,
      );
      ...
      <div className="container">
        ...
        <Row>
          ...
          <Col>
            ...
            <MediaQuery minWidth={1224}>
              <Form.Label htmlFor="inputPassword5"> <h4> Qty   <Button variant="danger" size="sm" onClick={() => { handleClick(item.id); handleDeletItemInCart() }} > <DeleteForeverIcon></DeleteForeverIcon> </Button> </h4>   </Form.Label>
              <Form.Control
                type="number"
                id="inputPassword5"
            ...
            <MediaQuery maxWidth={1224}>
              <Form.Label htmlFor="inputPassword5">
                <h5 style={{fontSize : '14px' }}> Qty   <Button variant="danger" size="sm" onClick={() => { handleClick(item.id); handleDeletItemInCart() }} > <DeleteForeverIcon></DeleteForeverIcon> </Button> </h5>
              </Form.Label>
              <Form.Control
                type="number"
                id="inputPassword5"
