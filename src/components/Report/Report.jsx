    ...
    const handleClick = () => {
        ...
        const fetchData = async () => {
            const result = await axios(
                ' https://34de-2405-9800-b600-90d4-fcf2-b249-79ac-955f.ngrok.io/api/order/getOrderForReport/' + dateTo + "/" + dateFrom ,
            );

            const result2 = await axios(
                ' https://34de-2405-9800-b600-90d4-fcf2-b249-79ac-955f.ngrok.io/api/order/getTotalPrice/' + dateTo + "/" + dateFrom ,
            );
