...
async function deleteAddress(addressDetail) {
  ...
  return fetch(
    " https://df54-2405-9800-b840-ee03-84dc-3a08-d5a0-96ce.ngrok.io/api/address/delete",
    {
      method: "POST",
      headers: {
...
async function updateAddress(addressDetail) {
  ...
  return fetch(
    " https://df54-2405-9800-b840-ee03-84dc-3a08-d5a0-96ce.ngrok.io/api/address/update",
    {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
...
export default function Address({ address, no }) {
  ...
  return (
    <div className="main">
      <h4 onClick={() => setOpen(!open)} className="place">
        {" "}
        {no}. {address.place}
      </h4>
      <div>
        <Collapse in={open}>
          <div hidden={editOpen}>
            <div id="example-collapse-text">
              ...
              <Button variant="text" onClick={() => setSigntinModalShow(true)}>
                <EditIcon />
              </Button>
              <Button
                variant="text"
          ...
          <Form className="formSignin">
            ...
            <Form.Group className="signinInput mb-3" controlId="fromBasicPlace">
              ...
              <Form.Control
                ...
                defaultValue={conAddress.recieverName}
              />
            </Form.Group>
            <Form.Group className="signinInput mb-3" controlId="fromBasicPlace">
              ...
              <Form.Control
                ...
                defaultValue={conAddress.recieverTel}
              />
            </Form.Group>
            <Form.Group className="signinInput mb-3" controlId="fromBasicPlace">
              ...
              <Form.Control
                ...
                defaultValue={conAddress.houseNumber}
              />
            </Form.Group>
            <Form.Group className="signinInput mb-3" controlId="fromBasicPlace">
              ...
              <Form.Control
                ...
                defaultValue={conAddress.address}
              />
            </Form.Group>
            <Form.Group className="signinInput mb-3" controlId="fromBasicPlace">
            ...
            <Form.Group className="signinInput mb-3" controlId="fromBasicPlace">
              ...
              <Form.Control
                ...
                defaultValue={conAddress.postal}
              />
            </Form.Group>
