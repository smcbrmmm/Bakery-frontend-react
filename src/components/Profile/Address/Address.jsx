...
async function deleteAddress(addressDetail) {
    ...
    return fetch(' https://e4a1-2405-9800-b600-6272-78c8-6ba8-7835-6aca.ngrok.io\/api/address/delete', {
        method: 'POST',
        headers: {
...
async function updateAddress(addressDetail) {
    ...
    return fetch(' https://e4a1-2405-9800-b600-6272-78c8-6ba8-7835-6aca.ngrok.io\/api/address/update', {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
        },
